# SalesPilot CRM — Official Landing Page & Git Worktree Demo

> Maintenance fork of [`deancourse/git-worktree-demo`](https://github.com/deancourse/git-worktree-demo).
> Primary Traditional Chinese documentation and Windows maintenance entrypoint: [`README.md`](README.md).
> Maintenance policies and Windows gate details: [`FORK.md`](FORK.md).
